...
public class PlayMusic : MonoBehaviour {
	...
	public AudioClip mainMusicTrump;				//Assign Audioclip for main 
    public AudioClip mainMusicKim;                  //Assign Audioclip for main 
	...
	public void PlayLevelMusic()
	{
		...
		switch (SceneManager.GetActiveScene().buildIndex)
		{
			...
			case 1:
                {
                    playerSel = GlobalVar.instance.GetPlayerSelection();
                                   //   GetPlayerSelection();
                    if (playerSel == 0)
                        musicSource.clip = mainMusicTrump;
                    else
                        musicSource.clip = mainMusicKim;
                }
                break;
		}
